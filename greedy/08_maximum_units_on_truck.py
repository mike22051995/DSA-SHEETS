...
class Solution:
    def maximumUnits(self, boxTypes, truckSize):
        ...
        boxesToTake = min(numberOfBoxes, truckSize - boxesLoaded)
...
if __name__ == "__main__":
    ...
    print(f"Test 1 - BoxTypes: [[1,3],[2,2],[3,1]], TruckSize: 4")
    print(f"Output: {sol.maximumUnits(boxTypes1,}")
    print(f"Expected: 8 (1 box of 3 units + 2 boxes of 2 units + 1 box of 1 unit)")
    vector<vector<int>> boxTypes2 = [{5, 10], [2, 5], [4, 7], [3, 9]}
    print(f"Test 2 - BoxTypes: [[5,10],[2,5],[4,7],[3,9]], TruckSize: 10")
    print(f"Output: {sol.maximumUnits(boxTypes2,}")
    print(f"Expected: 91")
    vector<vector<int>> boxTypes3 = [{1, 1], [1, 2], [1, 3]}
    print(f"Test 3 - BoxTypes: [[1,1],[1,2],[1,3]], TruckSize: 2")
    print(f"Output: {sol.maximumUnits(boxTypes3,}")
