...
if __name__ == "__main__":
    ...
    print(f"Test 1: {sol.characterReplacement('ABAB', 2)}")      # 4
    print(f"Test 2: {sol.characterReplacement('AABABBA', 1)}")   # 4
    print(f"Test 3: {sol.characterReplacement('AAAA', 0)}")      # 4
    print(f"Test 4: {sol.characterReplacement('ABBB', 2)}")      # 4
